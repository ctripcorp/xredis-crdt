...
void *REDISMODULE_API_FUNC(RedisModule_CreateKey)(void* db,RedisModuleString *keyname, int mode);
void *REDISMODULE_API_FUNC(RedisModule_OpenKey)(RedisModuleCtx *ctx, RedisModuleString *keyname, int mode);
void REDISMODULE_API_FUNC(RedisModule_FreeKey)(RedisModuleKey* key);
...
int REDISMODULE_API_FUNC(RedisModule_CrdtReplicateVerbatim)(RedisModuleCtx *ctx);
int *REDISMODULE_API_FUNC(RedisModule_ReplicationFeedAllSlaves)(int id, const char *cmdname, const char* fmt, ...);
...
int REDISMODULE_API_FUNC(RedisModule_RemoveExpire)(RedisModuleKey *key);
...
static int RedisModule_Init(RedisModuleCtx *ctx, const char *name, int ver, int apiver) {
    ...
    REDISMODULE_GET_API(CreateKey);
    REDISMODULE_GET_API(OpenKey);
    REDISMODULE_GET_API(FreeKey);
    ...
    REDISMODULE_GET_API(RemoveExpire);
