                ...
                test "run two process create conflict" {
                    ...
                    test "zset" {
                        if {[$master crdt.datainfo s1] != [$peer crdt.datainfo s1]} {
                            ...
                            puts [$master crdt.sismember s1 a] 
                            puts [$peer crdt.sismember s1 a]
                            puts [$master crdt.sismember s1 b] 
                            puts [$peer crdt.sismember s1 b]
                            puts [$master crdt.sismember s1 c] 
                            puts [$peer crdt.sismember s1 c]
                        }
                    }
                    ...
                    test "counter" {
                        if {[$master crdt.datainfo c1] != [$peer crdt.datainfo c1]} {
                            ...
                            puts [$master crdt.datainfo c1]
                            puts [$peer crdt.datainfo c1]
                        }
