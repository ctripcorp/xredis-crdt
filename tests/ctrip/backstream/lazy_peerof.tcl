    ...
    build_env {
        ...
        $master config rewrite
         ...
         start_server_by_config [get_master_srv config_file] [get_master_srv config] $master_host $master_port $master_stdout $master_stderr 1 {
            ...
            assert_equal [crdt_status $peer2 connected_slaves] 2
        }
    }
}
...
test "rdb-restart-peerof-cancel-lazy-peerof" {
    build_env {
        after 1000
        $master bgsave 
        waitForBgsave $master
...
test "rdb-restart-change-other-peer-cancel-lazy-peerof" {
    build_env {
        ...
        start_server_by_config [get_peer_srv config_file] [get_peer_srv config] $peer_host $peer_port $peer_stdout $peer_stderr $peer_gid {
            ...
            after 2000
            assert_equal [crdt_status $slave connected_slaves] 1
        }
    }
}
...
#         $master config rewrite 
#         after 1000
#         read_file [get_master_srv config_file]
