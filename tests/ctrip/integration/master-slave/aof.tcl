...
tags {"aof"} {
    ...
    # start_server_aof [list dir $server_path crdt-gid 1 loadmodule crdt.so] {
    #     test "AOF+SPOP: Server should have been started" {
    #         assert_equal 1 [is_alive $srv]
    #     }
    ...
    start_server {overrides {appendonly {yes} appendfilename {appendonly.aof} crdt-gid 1 } module crdt.so} {
    ...
    # start_server {overrides {appendonly {yes} appendfilename {appendonly.aof} appendfsync always crdt-gid 1 } module crdt.so} {
